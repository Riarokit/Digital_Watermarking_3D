...
if __name__ == "__main__":
    ...
    # OP. ノイズ攻撃
    # xyz_after = DW1F.noise_addition_attack(xyz_after, noise_percent=0.75, mode='gaussian', seed=42)

    # OP. スムージング攻撃
    # xyz_after = DW1F.smoothing_attack(xyz_after, lambda_val=0.2, iterations=30, k=6)
